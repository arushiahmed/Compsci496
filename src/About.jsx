    ...
    return (
      <div>
        ...
        <br></br><br></br>
          ...
          <p><strong>2. About: </strong> The about page will give them the infomation about the application and its purpose. When a returning user signing in, it will direct them to the about page.</p>
          ...
          <p><strong>4. Survey: </strong>This page is where the user will see their own survey. Currently this page show the survey sections and questions with no data that is fill. 
          ...
          <p><strong>6. Logout Button:</strong> The user will direct them back to the welcome page.</p>
          </div>       
      </div>
    );
  }
